...
export default function BrandStory() {
  return (
    <section className="bg-bone border-y-[0.5px] border-bronze/20 py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Text — left */}
          <div>
            <p className="section-subheading mb-3">Our Story</p>
            <h2 className="font-cormorant text-4xl md:text-5xl font-light text-charcoal mb-6 leading-[1.1]">
